...
- **Performance Optimized**: Intelligent register reading and optimization
...
| `coordinator.py`       | Central coordinator for Modbus data updates        |
| `register_optimizer.py`| Intelligent register grouping and batch reading   |
| `performance_monitor.py`| Performance monitoring and metrics                |
| `value_processor.py`  | Central value processing (scale, offset, mapping)  |
...
- **Template Reload**: Update device templates without restart
- **Services**: Performance monitoring and register optimization services
